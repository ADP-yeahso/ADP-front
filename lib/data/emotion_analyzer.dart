...
const Map<Emotion, List<String>> _keywords = {
  Emotion.sadness: ['슬프', '눈물', '힘들', '지치', '외롭', '그립', '울었', '속상', '눈물이'],
  Emotion.anger: ['화나', '화가', '짜증', '답답', '분노', '억울', '열받', '화났'],
  Emotion.guilt: ['미안', '죄책감', '후회', '자책', '잘못한', '미안해서'],
  Emotion.joy: ['고맙', '행복', '웃', '기쁘', '다행', '감사', '좋았', '웃었'],
  Emotion.calm: ['편안', '안정', '괜찮', '차분', '평온'],
};

const Map<Emotion, Recommendation> _recommendations = {
  Emotion.joy: Recommendation(
    quote: '오늘의 웃음이 내일을 버티는 힘이 되어줄 거예요.',
    musicTitle: '햇살 좋은 날의 어쿠스틱 플레이리스트',
    activity: '오늘의 기쁜 순간을 사진으로 남겨 보세요.',
  ),
  Emotion.calm: Recommendation(
    quote: '지금처럼만 하셔도 이미 충분히 잘하고 계세요.',
    musicTitle: '숲속 새소리 백색소음',
    activity: '가벼운 스트레칭으로 하루를 정리해 보세요.',
  ),
  Emotion.sadness: Recommendation(
    quote: '슬퍼도 괜찮아요. 그 마음, 잠시 내려놓아도 돼요.',
    musicTitle: '위로가 되는 잔잔한 피아노 선율',
    activity: '따뜻한 차 한 잔과 함께 5분만 쉬어가세요.',
  ),
  Emotion.anger: Recommendation(
    quote: '화가 나는 건 그만큼 애쓰고 있다는 증거예요.',
    musicTitle: '마음을 가라앉히는 자연의 소리',
    activity: '4초 들이쉬고 7초 참았다가 8초 내쉬는 호흡을 세 번 반복해 보세요.',
  ),
  Emotion.guilt: Recommendation(
...
EmotionAnalysisResult analyzeEmotion(String text) {
  final counts = <Emotion, int>{for (final e in Emotion.values) e: 0};
